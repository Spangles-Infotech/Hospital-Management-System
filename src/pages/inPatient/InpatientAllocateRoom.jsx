    ...
    <div className='flex flex-col gap-[20px]'>
       ...
       <div className='flex flex-col gap-[20px]'>
              ...
              <p
                ...
                className={`cursor-pointer px-5 py-2 rounded-full transition-all duration-500 ease-in-out ${
                  activeTab === tab?.section
                    ...
                    : "hover:bg-[#1F9CC6] hover:text-white text-[#969696]"
                }`}
              >
                {tab?.section}
              </p>
          ...
          <div className='flex gap-[20px] w-full'>
            <div className='flex flex-col gap-[20px] w-[70%] border-2 border-[#1F9CC6] p-5 rounded-[15px] '>
              ...
              <div className="flex gap-7 items-center justify-end p-5">
                ...
                <button 
                  ...
                  className="w-[150px] border border-[#1F9CC6] bg-white p-2 text-[#1F9CC6] rounded-full transition-all duration-500 ease-in-out hover:bg-[#1F9CC6] hover:text-white text-lg" 
                >
                 Discharge </button>
                <button className="w-[150px] bg-[#1F9CC6] p-2 text-white rounded-full hover:bg-[#1F9CC6] transition text-lg" onClick={()=>handleAllocateRoom(formData?.roomInfoId, formData?.status === "Allocated")} >{formData?.status === "Allocated" && formData?.roomNo ?  "Shift Room" : "Book Room" }</button>
              </div>
            </div>
