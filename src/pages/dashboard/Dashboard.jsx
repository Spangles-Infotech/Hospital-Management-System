  ...
  return (
    <section className="w-full p-6 container mx-auto">
      ...
      <div className="flex gap-6 mt-10">
        <div className="w-1/2 border border-[#1F9CC6] rounded-xl"></div>

        <div className="flex flex-col gap-1 w-1/2">
          <div className="flex gap-1">
            <div className="w-full border border-[#1F9CC6] rounded-tl-xl px-11 flex items-center text-lg gap-7 ">
              <img
                src={Appointments}
                alt="Appointments"
            ...
            <div className="w-full border border-[#1F9CC6] rounded-tr-xl p-11 flex items-center gap-7 text-lg">
              <img
                src={NewPaitents}
                alt="New Patients"
          ...
          <div className="flex gap-1 ">
            <div className="w-full border border-[#1F9CC6] rounded-bl-xl p-11 flex items-center gap-7 text-lg font-roboto">
              <img
                src={TotalDoctors}
                alt="Total Doctors"
            ...
            <div className="w-full border border-[#1F9CC6] rounded-br-xl p-11 flex items-center text-lg gap-7">
              <img
                src={Nurses}
                alt="Nurses"
                className="w-[60px] h-[60px] bg-blue-100 rounded-md p-1"
