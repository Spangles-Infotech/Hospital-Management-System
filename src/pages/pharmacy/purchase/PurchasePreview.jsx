...
const PurchasePreview = () => {
  ...
  return (
    <section className='p-4'>
      ...
      <PharmacyPreviewInfo fields={supplierPurchasePreviewField} data={data} isPreviewWithIcon={false}/>
      ...
      <table className="w-full border-collapse  ">
        ...
        <tbody>
          {data?.medicines?.map((medicine, index) => (
            <tr key={index} className="border rounded-[15px] border-primary text-center">
              <td className="px-4 py-3 border border-primary ">{medicine?.medicineCategory}</td>
              <td className="px-4 py-3 border border-primary">{medicine?.medicineName}</td>
              <td className="px-4 py-3 border border-primary">{medicine?.hsnCode || "-"}</td>
              ...
              <td className="px-4 py-3 border border-primary">{medicine?.unit}</td>
              <td className="px-4 py-3 border border-primary">{medicine?.price?.toFixed(2)}</td>
              <td className="px-4 py-3 border border-primary">{medicine?.gst}%</td>
              <td className="px-4 py-2 border border-primary">{medicine?.amount?.toFixed(2)}</td>
            </tr>
          ))}
        </tbody>
      </table>
