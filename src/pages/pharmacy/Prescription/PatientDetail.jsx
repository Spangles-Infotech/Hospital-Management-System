...
const PatientDetail = ({isRoom}) => {
  ...
  const patientDetails = [
    ...
    { label: "Gender", value: "gender", valueClass: "text-primary" },
    { label: "Blood Group", value: "bloodGroup", valueClass: "text-green-600" },
  ];

  const additionalInfo = [
    { label: "Address", value: "address", valueClass: "text-primary" },
    { label: "Phone Number", value: "phoneNumber", valueClass: "text-primary" },
  ];

  const vitals = [
    { label: "Temperature", value: "temperature", valueClass: "text-red-600 bg-red-100 rounded-md px-1 " },
    { label: "Weight", value: "weight", valueClass: "text-primary" },
    { label: "Height", value: "height", valueClass: "text-primary" },
    { label: "Pulse Rate", value: "pulse", valueClass: "text-primary" },
    { label: "Blood Pressure", value: "bloodPressure", valueClass: "text-primary" },
    { label: "Symptom", value: "symptoms", valueClass: "text-red-600 bg-red-100 rounded-md px-1" },
  ];

  const rooms1 = [
    { label: "Section", value: "section", valueClass: "text-primary" },
    { label: "Room no.", value: "roomNumber", valueClass: "text-primary" },
    { label: "No. of Days", value: "noOfDays", valueClass: "text-primary" },
  ]
  const rooms2 = [
    { label: "From Date", value: "from", valueClass: "text-primary", isDate:true },
    { label: "To Date", value: "to", valueClass: "text-primary", isDate:true },
  ]
