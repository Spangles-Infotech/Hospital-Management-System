    ...
    <div className="mt-5">
      <div className="flex      ">
        <div className="">
        {
          ...
          :
          <div className="border-[#1F9CC6] border rounded-[15px] mt-5 w-[400px]  h-[150px] p-6 bg-white">
        ...
        <div className={`${!isDiscount ? "hidden": ""}`}>
          <div className="border-[#1F9CC6] border rounded-[15px] mt-5 w-[350px]   p-6 h-[170px] bg-white">
        ...
        <div className="border-[#1F9CC6] ml-2   border rounded-[15px]  mt-1 w-[20%] bg-white" >
