      ...
      <div className='flex flex-col gap-[25px] '>
        <div className='flex gap-[20px] items-center'>
          ...
          <div className={`h-[98px] flex justify-end items-end ${errors?.title ? "pb-[14px]" : "" }`}>
            <button onClick={handlePostDesignation} className="w-[150px] bg-primary border p-2 text-white rounded-lg hover:bg-white hover:border-primary hover:text-primary transition-all duration-300 ease-in-out text-lg h-[50px] font-poppins" > Add </button>
          </div>
        </div>
