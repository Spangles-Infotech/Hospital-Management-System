  ...
  return (
    <section className='w-[80%] flex flex-col gap-[20px]'>
      ...
      <div className='flex flex-col gap-[20px]'>
        <div className='flex gap-[30px] items-center'>
          <input 
            ...
            className='cursor-pointer accent-[#1F9CC6] size-[25px]  border-[#1F9CC6] rounded-[5px]' 
          ...
          />
          <label className='text-[18px] font-poppins font-[500] text-[#1F9CC6]'>Full Access</label>
        </div>
        {
          roleFields.map((item)=>(
            <div key={item.label} className='flex flex-col gap-[20px]'>
              <div className='flex gap-[30px] items-center'>
                ...
                />
                <span className='text-[18px] font-poppins font-[500] text-[#1F9CC6]'>{item.label}</span>
              </div>
      ...
      <div className="flex mt-7 gap-7 items-center justify-end">
            ...
            <button type="submit" onClick={handlePostAccess} className="w-[15%] bg-[#1F9CC6] p-2 text-white rounded-lg hover:bg-[#1F9CC6] transition text-lg">
              Save
            </button>
          </div>
    </section>
