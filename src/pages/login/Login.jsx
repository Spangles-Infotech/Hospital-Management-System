  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // const response = await axios.post("https://hospital-management-system-eexc.onrender.com/api/auth/login", {
        // const response = await axios.post("https://server.gunamhospitals.com/api/auth/login", {
...
<div className="w-[430px] h-[440px] bg-white relative p-10 shadow-lg rounded-md flex flex-col items-center font-roboto right-[280px]">
      ...
      <div>
        <img 
        className="absolute right-10 top-0 w-[530px] h-[500px] object-contain bg-[#1F9CC6] py-10"
        src={poster}/>
      </div>
