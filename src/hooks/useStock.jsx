...
export const useStock = () => {
    ...
    const stockFormField = [
      ...
      [{label: "Category",name: "category",type: "select",options: categoryData?.map((option) => ({ label: option.name, value: option.name })),isAdd:true, fields:tagFormFields["medicine"], title:"Add Category", route:"/add-tags", refetch:refetch},{label: "Strength",name: "strength",type: "select",options:strengthData?.map((option) => ({ label: option.name, value: option.name })), isAdd:true, fields:tagFormFields["strength"], title:"Add Strength", route:"/add-tags", refetch:strengthRefetch}],
      [{ label: "Unit", name: "unit", type: "select", options: packsData?.map((option) => ({ label: option.name, value: option.name })), isAdd:true, fields:tagFormFields["pack"], title:"Add unit", route:"/add-tags", refetch:packRefetch  },{ label: "Low Stock", name: "lowStock", type: "number" }],
