...
export const PharmacyPreviewInfo = ({fields, data, isPreviewWithIcon=true, isForm=false}) => {
  ...
  return (
    <div className= {`bg-white rounded-[15px] border border-[#1F9CC6] p-5 flex ${isForm ? "flex-col" : "flex-wrap" } gap-[15px]`}>
        <div className={`flex justify-between items-center gap-[20px] ${!isForm ? "hidden" : "" }`}>
            <p className='text-[20px] font-[600] text-[#1F9CC6]'>New Purchase</p>
            <div className='flex gap-5'>
                <p className='text-[20px] font-[500] text-[#1F9CC6]'>Order Number</p>
