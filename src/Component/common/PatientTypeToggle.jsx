...
export const PatientTypeToggle = () => {
    ...
    return (
        <label
          htmlFor="check"
          className="bg-white border border-[#1F9CC6] relative w-20 h-10 rounded-full flex items-center cursor-pointer"
        >
          ...
          <span
            className={`w-2/5 h-4/5 bg-[#1F9CC6] absolute rounded-full left-1 transition-all duration-300 ease-in-out ${
