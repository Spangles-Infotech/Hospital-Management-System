...
export const Modal = ({ isOpen, onClose, content: Content, contentProps }) => {
  ...
  return (
    <div 
      ...
      className={`fixed top-[128px] right-0 inset-0 z-50 flex items-center justify-center bg-white bg-opacity-70 transition-all duration-500 ease-in-out ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}
    >
