  ...
  return (
    <section className="p-3 font-poppins">
      <div className="flex gap-8">
        <div className="w-3/4 border border-[#1F9CC6] p-7 rounded-lg shadow-lg">
            ...
            {medicineType.map((type) => (
              <p
                ...
                className={`relative cursor-pointer text-stone-400 pb-2 ${
                  selectedType === type ? "text-[#1F9CC6] border-b-2 border-[#1F9CC6]" : "hover:text-[#1F9CC6]"
                }`}
              >
                {type}
              </p>
          ...
          <div className="flex justify-center gap-3 mt-4">
            <button
              ...
              className="text-white bg-[#1F9CC6] px-10 py-2 rounded-full hover:bg-[#1F9CC6]/90"
            >
              Add
            </button>
            <button
