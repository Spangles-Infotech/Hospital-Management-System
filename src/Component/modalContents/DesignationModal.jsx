    ...
    <div className='flex flex-col gap-6 p-4 w-[400px] h-[300px] overflow-y-auto'>
      <div className='flex gap-4 items-end'>
        ...
        <button 
          ...
          className="h-[50px] px-6 bg-primary border text-white rounded-lg hover:bg-white hover:border-primary hover:text-primary transition-all duration-300 ease-in-out text-lg font-poppins"
        >
          Add
        </button>
      </div>
      ...
      <div className='flex flex-wrap gap-3 mt-2'>
        {data?.map((item) => (
          <div key={item._id} className='h-[40px] rounded-full border-none bg-[#E6F5F6] text-primary flex px-4 gap-2 items-center'>
