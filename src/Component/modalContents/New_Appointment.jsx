                    ...
                    <>
                      <div className={`flex justify-between items-center cursor-pointer`}>
                        ...
                        <div className="text-slate-700 text-lg font-medium flex gap-2">
                          ...
                          <p className="text-primary">{selectedPatient?.patientName?.name}</p>
                        </div>
                        <div className="text-slate-700 text-lg font-medium flex gap-2">
                          Phone Number:
                          <p className="text-primary">{selectedPatient?.mobileNumber?.code} {selectedPatient?.mobileNumber?.number}</p>
                        </div>
                      </div>
                    ...
                    <Fragment key={index}>
                      <div className={`flex justify-between items-center cursor-pointer`} onClick={()=>handleClickPatient(item)}>
                        ...
                        <div className="text-slate-700 text-lg font-medium flex gap-2">
                          ...
                          <p className="text-primary">{item.patientName.name}</p>
                        </div>
                        <div className="text-slate-700 text-lg font-medium flex gap-2">
                          Phone Number:
                          <p className="text-primary">{item?.mobileNumber.code} {item.mobileNumber.number}</p>
                        </div>
                      </div>
                      <div className="w-full h-[1px] bg-stone-300 "></div>
                    </Fragment>
